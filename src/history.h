...
// CapturePieceToHistory is addressed by a move's [piece][to][prev piece type][captured piece type]
using CapturePieceToHistory = Stats<std::int16_t, 10692, PIECE_NB, SQUARE_NB, PIECE_TYPE_NB, PIECE_TYPE_NB>;
